...
export default function AuthGoogle({ status, error, canRegister }: AuthGoogleProps) {
    ...
    return (
        <AuthGoogleLayout>
            ...
            <div className="space-y-4">
                ...
                <Link
                    href="/login"
                    className="cursor-pointer w-full bg-white border-2 border-zinc-100 py-5 rounded-[1.5rem] flex items-center justify-center gap-4 hover:border-secondary hover:bg-zinc-50 transition-all duration-300 group shadow-sm"
                >
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className=" px-4 text-zinc-500 font-semibold tracking-wider">
                            Ou
                        </span>
                    </div>
                </div>
            ...
            <p className="text-foreground/60 text-base leading-relaxed text-center">
